            ...
            <div className="w-full min-w-0 flex flex-col md:flex-row gap-16 items-stretch">
              ...
              <div className="w-full md:w-[calc(50%-4rem)] md:min-w-0 shrink-0 text-foreground bg-transparent">
                ...
                <div className="text-body1 space-y-4 mt-7">
                  <p>
                    I’m from Chicago, where I studied graphic design at UIC, a program grounded in Swiss and International design principles that shaped my early approach to visual storytelling. After moving to Seattle, I transitioned into UX design and spent several years working across corporations, agencies, and startups, learning how research‑driven design creates more authentic user experiences. I’m now based in Miami, balancing product design with ongoing AI‑driven exploration and time outdoors cycling in the warm coastal environment.
                  </p>
                </div>
              </div>
