...
export default function ProjectCard({
  ...
  const content = (
    <div className="w-full min-w-0 grid grid-cols-1 md:grid-cols-2 gap-0 items-stretch min-h-0 md:min-h-[448px] rounded-2xl overflow-hidden shadow-elevation bg-[oklch(100%_0_0)]">
      ...
      <Card className="flex flex-col justify-center overflow-hidden rounded-b-2xl md:rounded-b-none md:rounded-r-2xl bg-[oklch(100%_0_0)] border-0 shadow-none p-0 gap-0">
        <CardContent className="flex flex-col justify-center p-4 md:p-8 lg:p-16 text-left bg-[oklch(100%_0_0)]">
          <h3 className="text-h4 text-[oklch(0%_0_0)] m-0 mb-2">
            {title}
          </h3>
