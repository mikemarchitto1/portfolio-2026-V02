...
export default function ProjectCard({
  ...
  const content = (
    <div
      className={`overflow-hidden flex flex-col flex-1 min-h-0 w-full p-[64px] rounded-lg ${className ?? "bg-transparent"}`}
      data-project-card-content
    >
      {/* Inner white wrapper: 24px frame around content */}
      <div className="inner-card group relative flex flex-col gap-0 flex-1 min-h-0 p-[24px] bg-[oklch(100%_0_0)] rounded-lg [box-shadow:0_0_8px_oklch(0%_0_0/0.05)]">
        <div
