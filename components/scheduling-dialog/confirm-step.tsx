  ...
  return (
    <div className="flex w-full flex-row items-start gap-3 text-left">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <h2 className="text-subtitle1 text-foreground dark:text-white color:text-white pt-0.5">This meeting is scheduled</h2>
        <p className="text-body2 text-foreground mt-1">We sent a calendar invite with the details to everyone.</p>
        <dl className="flex flex-col gap-4 text-body2 mt-4 items-start">
...
<dd className="text-foreground dark:text-white color:text-white mt-0.5">
        ...
        <div className="flex flex-wrap gap-1 mt-4 items-center justify-start">
          <button type="button" className="text-body2 text-foreground underline hover:no-underline" onClick={onReschedule}>Reschedule</button>
        ...
        <div className="mt-3 w-full flex justify-start -ml-3">
