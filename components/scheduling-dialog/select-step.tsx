            ...
            >
              <TabsTrigger
                ...
                className={cn(
                  ...
                  timeFormat === "12h"
                    ? "border border-border dark:border-[oklch(30%_0.01_264)] color:border-[oklch(48%_0.035_165)] bg-muted dark:bg-[oklch(26%_0.01_264)] color:bg-[oklch(38%_0.035_165)] text-foreground dark:text-white color:text-white"
