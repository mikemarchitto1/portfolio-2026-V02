...
export default function ImpactTechStackSection() {
  ...
  return (
    <section className="w-full min-w-0 min-h-0 md:min-h-[520px] py-6 md:py-9 lg:pt-0 lg:pb-12 bg-transparent">
          ...
          <div className="w-full min-w-0 flex flex-col py-4 md:py-8 lg:py-16 px-0 lg:px-16 bg-transparent">
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-0 flex flex-col min-h-0">
                <Card className="rounded-2xl pt-4 px-4 pb-4 md:pt-8 md:px-8 md:pb-8 lg:pt-[72px] lg:px-12 lg:pb-12 w-full min-w-0 flex-1 min-h-0 flex flex-col overflow-hidden bg-[oklch(100%_0_0)] border-0 gap-0">
