                  ...
                  >
                    <div
                      className={cn(
                        ...
                        hideStats
                          ? "grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-auto-rows-[56px] md:grid-auto-rows-[72px] lg:grid-auto-rows-[80px] content-center max-w-none items-center justify-items-center gap-8 md:gap-4"
