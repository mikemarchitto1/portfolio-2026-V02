...
export function StatCounter({ value, label, startAnimation }: StatCounterProps) {
  ...
  return (
    <div className="w-full h-full min-h-0 flex flex-col items-center justify-center text-center p-[48px] pt-[36px] rounded-2xl shadow-elevation bg-white text-foreground">
      ...
      <div className="text-h5 font-normal text-foreground">
        {label}
      </div>
    </div>
  );
